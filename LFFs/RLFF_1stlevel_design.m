function  RLFF_1stlevel_design(subjname,fmridir)
global FMRI
...
f_mri = spm_select('ExtFPList',fmripath,[DATAprefix 'rest_cleaned.nii']);
...
jobs{1}.stats{1}.fmri_spec.sess.scans = [cellstr(f_mri(dummyoff+1:end,:))];
